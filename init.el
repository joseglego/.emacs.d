...
(custom-set-variables
 ...
 '(package-selected-packages
   '(graphql graphql-doc graphql-mode bazel prettier-js go-mode stylus-mode rainbow-mode add-node-modules-path lsp-mode lsp-treemacs helm-lsp projectile butler emojify dockerfile-mode docker-compose-mode docker dashboard all-the-icons groovy-mode smartparens flow-minor-mode lorem-ipsum js2-refactor xref-js2 company company-tabnine manage-minor-mode rjsx-mode pug-mode flycheck markdown-preview-eww markdown-mode emmet-mode react-snippets multiple-cursors scss-mode yaml-mode js-doc magit-gitflow web-mode typescript-mode rbenv powerline multi-web-mode json-mode js2-mode helm exec-path-from-shell darkokai-theme whitespace-cleanup-mode neotree yasnippet auto-complete flycheck-kotlin kotlin-mode)))
(custom-set-faces
